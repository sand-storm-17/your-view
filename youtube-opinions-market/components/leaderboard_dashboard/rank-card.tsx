...
export default function RankCard(props: RankProps) {
  return (
    <div className="flex gap-2 border border-none bg-accent-200 mx-10 px-10 py-2 justify-between rounded-tr-lg rounded-bl-lg font-heading1 text-md shadow-sm shadow-accent-500">
